...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_GAMMA],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_GAMMA],
  ),
  #(
  #  "ford",
