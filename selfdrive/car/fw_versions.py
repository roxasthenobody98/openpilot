...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, FORD_OPEN_IDS_SESSION, FORD_VERSION_REQUEST, FORD_END_IDS_SESSION_REQ],
    [TESTER_PRESENT_RESPONSE, FORD_VERSION_RESPONSE, FORD_END_IDS_SESSION_RES],
  ),
]
