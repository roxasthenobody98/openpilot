...
#FORD_VERSION_REQUEST_BETA = b'\x22\xa5'
#FORD_VERSION_RESPONSE_BETA = b'\x62\xa5\x00\xfe'

FORD_VERSION_REQUEST_GAMMA = b'\x22\xf4\x7f' #b'\x22\x40'
FORD_VERSION_RESPONSE_GAMMA = b'\x62\xf4\x7f' #b'\x62\x40\x4c\x19\x46\x1e'

FORD_VERSION_REQUEST_DELTA = b'\x22\xf1\x81'
FORD_VERSION_RESPONSE_DELTA = b'\x62\xf1\x81'
...
REQUESTS = [
  ...
  #(
  #  "ford",
  #  [TESTER_PRESENT_REQUEST, FORD_VERSION_REQUEST_BETA],
  #  [TESTER_PRESENT_RESPONSE, FORD_VERSION_RESPONSE_BETA],
  #),
  (
    "ford",
