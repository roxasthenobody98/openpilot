...
FORD_VERSION_REQUEST = b'\x22\x02'
FORD_VERSION_RESPONSE = b'\x62\x02'

FORD_VERSION_REQUEST_ALPHA = b'\x22\xe6\xf3'
FORD_VERSION_RESPONSE_ALPHA = b'\x62\xe6\xf3\x0c'

FORD_VERSION_REQUEST_BETA = b'\x22\xf1\x82' #b'\x22\xa5'
FORD_VERSION_RESPONSE_BETA = b'\x62\xf1\x82' #b'\x62\xa5\x00\xfe'

FORD_VERSION_REQUEST_GAMMA = b'\x22\xf1\x88' #b'\x22\x40'
FORD_VERSION_RESPONSE_GAMMA = b'\x62\xf1\x88' #b'\x62\x40\x4c\x19\x46\x1e'

FORD_VERSION_REQUEST_DELTA = b'\x22\xf1\x8c'
FORD_VERSION_RESPONSE_DELTA = b'\x62\xf1\x8c'
...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE],
  ),
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_ALPHA],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_ALPHA],
  ),
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_BETA, FORD_VERSION_REQUEST_GAMMA, FORD_VERSION_REQUEST_DELTA],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_BETA, FORD_VERSION_RESPONSE_GAMMA, FORD_VERSION_RESPONSE_DELTA],
  ),
  #(
  #  "ford",
  #  [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_GAMMA],
  #  [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_GAMMA],
  #),
  #(
  #  "ford",
  #  [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_DELTA],
  #  [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_DELTA],
  #),
]
