...
FORD_VERSION_REQUEST_BETA = b'\x22\xf1\x81' #b'\x22\xa5'
FORD_VERSION_RESPONSE_BETA = b'\x62\xf1\x81' #b'\x62\xa5\x00\xfe'

FORD_VERSION_REQUEST_GAMMA = b'\x22\xf1\x88' #b'\x22\x40'
FORD_VERSION_RESPONSE_GAMMA = b'\x62\xf1\x88' #b'\x62\x40\x4c\x19\x46\x1e'

FORD_VERSION_REQUEST_DELTA = b'\x22\xf1\x24'
#FORD_VERSION_RESPONSE_DELTA = b'\x62\xf1\x89'
FLOW_CONTROL_TX = b'\x30'
FLOW_CONTROL_RX = b'\x23'
...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_BETA],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_BETA],
  ),
  (
    "ford",
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, DEFAULT_DIAGNOSTIC_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_DELTA, FLOW_CONTROL_TX],
    [TESTER_PRESENT_RESPONSE, DEFAULT_DIAGNOSTIC_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_GEN, FLOW_CONTROL_RX],
  ),
]
