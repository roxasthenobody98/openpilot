...
FORD_VERSION_REQUEST_GAMMA = b'\x03\x22\xf4\x7f' #b'\x22\x40'
FORD_VERSION_RESPONSE_GAMMA = b'\x04\x62\xf4\x7f' #b'\x62\x40\x4c\x19\x46\x1e'

FORD_VERSION_REQUEST_DELTA = b'\x03\x22\xf1\x81'
FORD_VERSION_RESPONSE_DELTA = b'\x04\x62\xf1\x81'
...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_GAMMA],
    [TESTER_PRESENT_RESPONSE, FORD_VERSION_RESPONSE_GAMMA],
  ),
  (
    "ford",
    [TESTER_PRESENT_REQUEST, EXTENDED_DIAGNOSTIC_REQUEST, FORD_VERSION_REQUEST_DELTA],
    [TESTER_PRESENT_RESPONSE, EXTENDED_DIAGNOSTIC_RESPONSE, FORD_VERSION_RESPONSE_DELTA],
  ),
]
