...
FORD_VERSION_REQUEST_MULTI = bytes([uds.SERVICE_TYPE.READ_DATA_BY_IDENTIFIER]) + \
  p16(0xf113) + \
  p16(uds.VEHICLE_MANUFACTURER_ECU_SOFTWARE_NUMBER) + \
  p16(0xf120) + \
  p16(0xf124) + \
  p16(0xf125) + \
  p16(0xf18c) + \
...
FORD_MODULE_READ_END_A = b'\x22\xc1\xa1'

FORD_MODULE_READ_END_B = b'\x22\xf1\x06'
...
REQUESTS = [
  ...
  (
    "ford",
    [TESTER_PRESENT_REQUEST, FORD_VERSION_REQUEST_MULTI],
    [TESTER_PRESENT_RESPONSE, FORD_VERSION_RESPONSE_MULTI],
  ),
]
