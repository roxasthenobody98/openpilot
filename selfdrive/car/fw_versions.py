...
FORD_VERSION_RESPONSE = b'\x62\xd1\x00\x01'

#FORD_VERSION_REQUEST_ALPHA = b'\x22\x99\x56'
#FORD_VERSION_RESPONSE_ALPHA = b'\x62\x99\x56\x46'
...
REQUESTS = [
  ...
  #(
  #  "ford",
  #  [TESTER_PRESENT_REQUEST, FORD_VERSION_REQUEST_ALPHA],
  #  [TESTER_PRESENT_RESPONSE, FORD_VERSION_RESPONSE_ALPHA],
  #),
  (
    "ford",
