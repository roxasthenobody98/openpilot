...
def get_startup_alert(car_recognized, controller_available):
  alert = 'startup'
  if Params().get("GitRemote", encoding="utf8") in ['git@github.com:roxasthenobody98/openpilot.git', 'https://github.com/roxasthenobody98/openpilot.git']:
    if Params().get("GitBranch", encoding="utf8") not in ['devel', 'release2-staging', 'dashcam-staging', 'release2', 'dashcam', 'ford-devel', 'release-ford']:
      alert = 'startupMaster'
